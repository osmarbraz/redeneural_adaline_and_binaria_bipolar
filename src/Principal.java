...
/**
 * Exemplo 2.18 pag. 83 Livro Fausett, Laurene V Fundamentals of Neural NetWorks
 * Adaline para uma funcao AND com entrada binaria (0,1) e alvo bipolar(1,-1)
 */
public class Principal {

    public static void main(String args[]) {
        //Matriz de dados binaria
        int s[][] = {{1, 1}, {1, 0}, {0, 1}, {0, 0}};
        ...
        double b = java.lang.Math.random(); //peso bias		

        double w[] = new double[n];
        for (int i = 0; i < n; i++) {
            w[i] = java.lang.Math.random();
        }
